...
def test_exit_code(initproj, cmd, exit_code, mocker):
    ...
    mocker.spy(tox.exc, 'exit_code_str')
    ...
    if exit_code:
        ...
        assert tox.exc.exit_code_str.call_count == 1
        (args, kwargs) = tox.exc.exit_code_str.call_args
        assert kwargs == {}
        ...
        # need mocker.spy above
        assert tox.exc.exit_code_str.call_count == 0
