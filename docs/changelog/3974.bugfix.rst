...
- honor the stop signal in the Windows overlapped-I/O reader while a read is still pending, so shutdown no longer risks
  hanging on a child that holds its pipe open without producing output.
